...
const stockVideoUrl =
  "https://cdn.builder.io/api/v1/image/assets%2Fe9588cc2e48046eda97120fbe07da119%2F10c3ed330bcf4e15bf2a52fe283ec99f?format=webp&width=800";
const user2VideoUrl =
  "https://images.pexels.com/photos/6942776/pexels-photo-6942776.jpeg?auto=compress&cs=tinysrgb&w=800";
const user3VideoUrl =
  "https://images.pexels.com/photos/27603433/pexels-photo-27603433.jpeg?auto=compress&cs=tinysrgb&w=800";
const user4VideoUrl =
  "https://images.pexels.com/photos/15023413/pexels-photo-15023413.jpeg?auto=compress&cs=tinysrgb&w=800";
    ...
    return (
      <div className="flex justify-center mb-4 px-4">
        <div className="relative">
          <div
            className={`bg-gray-800 rounded-lg overflow-hidden border border-app-border transition-all duration-300 ${
              transcriptExpanded
                ? "w-56 h-32 sm:w-64 sm:h-36"
                : "w-72 h-40 sm:w-80 sm:h-48 md:w-[400px] md:h-[225px]"
            }`}
          >
            <img
              src={stockVideoUrl}
        ...
        <div className="flex gap-4">
          ...
          <div className="relative">
            <div
              className={`bg-gray-800 rounded-lg overflow-hidden border border-app-border transition-all duration-300 ${
                transcriptExpanded
                  ? "w-36 h-28 sm:w-40 sm:h-32"
                  : "w-48 h-36 sm:w-56 sm:h-42 md:w-64 md:h-48"
              }`}
            >
              <img
                src={stockVideoUrl}
        ...
        <div className="relative">
          <div
            className={`grid grid-cols-2 gap-4 transition-all duration-300 ${
              transcriptExpanded
                ? "w-60 h-48"
                : "w-80 h-64 sm:w-96 sm:h-72 md:w-[400px] md:h-80"
            }`}
          >
            {/* User 1 (You) */}
